...
class Config(object):
  ...
  AWS_SNS_JOB_REQUEST_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:hanzeh_job_requests"
  AWS_SNS_JOB_COMPLETE_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:hanzeh_job_results"
  AWS_SNS_RESULT_RESTORE_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:hanzeh_results_restore"
  ...
  MAIL_DEFAULT_SENDER = "hanzeh@mpcs-cc.com"
